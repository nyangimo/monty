 ...
 * @n: integer
 * @prev: to point to the previous element of the stack (or queue)
 * @next: to point to the next element of the stack (or queue)
 *
 * Description: the doubly linked list node structure
 * for queues, stacks FIFO, LIFO Holberton project
 */
 ...
 * for stack, queues, FIFO, LIFO Holberton project
 */
